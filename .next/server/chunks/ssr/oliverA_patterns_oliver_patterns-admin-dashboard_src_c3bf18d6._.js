...
;
;
function ContactTable({ contacts, onView, onRespond, onDelete, isLoading, error, currentPage, totalPages, totalData, hasNextPage, hasPrevPage, onPageChange }) {
                            ...
                            children: contacts.map((contact)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$oliverA_patterns$2f$oliver_patterns$2d$admin$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$oliverA_patterns$2f$oliver_patterns$2d$admin$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$oliverA_patterns$2f$oliver_patterns$2d$admin$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: `px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getStatusBadge(contact.status)}`,
                                                children: contact.status === 'read' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$oliverA_patterns$2f$oliver_patterns$2d$admin$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$oliverA_patterns$2f$oliver_patterns$2d$admin$2d$dashboard$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$mail$2d$open$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__MailOpen$3e$__["MailOpen"], {}, void 0, false, {
                                                    fileName: "[project]/oliverA_patterns/oliver_patterns-admin-dashboard/src/app/admin-dashboard/contact-management/_components/contactTable.tsx",
                                                    lineNumber: 225,
                                                    columnNumber: 50
...
const useGetContacts = (accessToken, page = 1, limit = 10)=>{
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$oliverA_patterns$2f$oliver_patterns$2d$admin$2d$dashboard$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            const response = await fetch(`${API_BASE_URL}/contact?page=${page}&limit=${limit}`, {
                headers: {
        ...
        onMutate: async (contactId)=>{
            ...
            queryClient.setQueriesData({
                ...
                return {
                    ...
                    data: {
                        ...old.data,
                        items: old.data.items.filter((contact)=>contact._id !== contactId),
                        paginationInfo: {
        ...
        onMutate: async ({ contactId, status })=>{
            ...
            queryClient.setQueriesData({
                ...
                return {
                    ...
                    data: {
                        ...old.data,
                        items: old.data.items.map((contact)=>contact._id === contactId ? {
                                ...contact,
                                status
                            } : contact)
                    }
...
;
;
function RespondDialog({ contact, isOpen, accessToken, onClose, onSuccess }) {
    const updateStatusMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$oliverA_patterns$2f$oliver_patterns$2d$admin$2d$dashboard$2f$src$2f$lib$2f$contactApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useUpdateContactStatus"])(accessToken, {
        onSuccess: ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$oliverA_patterns$2f$oliver_patterns$2d$admin$2d$dashboard$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('Marked as read successfully!');
            onSuccess();
        },
        onError: (error)=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$oliverA_patterns$2f$oliver_patterns$2d$admin$2d$dashboard$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error.message || 'Failed to update status');
        }
    });
...
;
;
function ContactManagement({ accessToken }) {
    ...
    // Fetch contacts
    const { data: contactsData, isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$oliverA_patterns$2f$oliver_patterns$2d$admin$2d$dashboard$2f$src$2f$lib$2f$contactApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useGetContacts"])(accessToken, currentPage, 8);
    // Delete mutation
    const deleteMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$oliverA_patterns$2f$oliver_patterns$2d$admin$2d$dashboard$2f$src$2f$lib$2f$contactApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useDeleteContact"])(accessToken, {
        onSuccess: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$oliverA_patterns$2f$oliver_patterns$2d$admin$2d$dashboard$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('Contact deleted successfully'),
        onError: (err)=>__TURBOPACK__imported__module__$5b$project$5d2f$oliverA_patterns$2f$oliver_patterns$2d$admin$2d$dashboard$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(err.message)
    });
...
//# sourceMappingURL=oliverA_patterns_oliver_patterns-admin-dashboard_src_c3bf18d6._.js.map