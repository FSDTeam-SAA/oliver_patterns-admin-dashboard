...
function UserManagement() {
    ...
    const [accessToken, setAccessToken] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$oliverA_patterns$2f$oliver_patterns$2d$admin$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$oliverA_patterns$2f$oliver_patterns$2d$admin$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserManagement.useEffect": ()=>{
            if ("TURBOPACK compile-time truthy", 1) {
                ...
                const tokenFromCookie = (_document_cookie_split_find = document.cookie.split('; ').find({
                    "UserManagement.useEffect": (row)=>row.startsWith('accessToken=')
                }["UserManagement.useEffect"])) === null || _document_cookie_split_find === void 0 ? void 0 : _document_cookie_split_find.split('=')[1];
    ...
    const { data: usersData, isLoading, error } = useGetUsers(accessToken, currentPage, 10);
    // Debugging logs
    ...
    const pagination = (usersData === null || usersData === void 0 ? void 0 : usersData.pagination) || {
        currentPage: 1,
        totalPages: 1,
        totalData: 0,
        hasNextPage: false,
...
_s(UserManagement, "1+JYS4NWniPTfs5LCNUV2AAjujg=", true);
_c = UserManagement;
var _c;
...
//# sourceMappingURL=oliverA_patterns_oliver_patterns-admin-dashboard_src_5747bfd3._.js.map